...
var mapID = 'map';
var mapCenter = document.querySelector('[data-map-center]') && document.querySelector('[data-map-center]').dataset.mapCenter.split(',') || [50.450976, 30.522575];
var mapObjects = document.querySelectorAll('[data-map-obj]');
var mapsArr = [];
mapObjects.forEach(function (el) {
...
function initMap() {
  ...
  if (mapEl) {
    ...
    mapsArr.forEach(function (item) {
      var marker = new google.maps.Marker({
        position: {
          lat: item.coords[0],
          lng: item.coords[1]
        },
        map: map //title: 'Hello World!' // Всплывающяя подсказка
