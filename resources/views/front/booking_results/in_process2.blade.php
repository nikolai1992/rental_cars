                    ...
                    <div class="user-booking-result">
                        <div class="user-booking-result__content">
                            <div class="user-booking-result__content-inner">
                                ...
                                <div class="user-booking-result__hidden-text" id="user-booking-result-hidden-text" hidden>{{App\Models\Translation::getTranslWord($words, $sel_lang, "for_cancel_order")}} <a class="underline" href="{{$create_ticket}}">{{App\Models\Translation::getTranslWord($words, $sel_lang, "create_ticket")}}</a> в Вашем личном кабинете</div>
                            </div>
                        </div>
                                    ...
                                    <div>
                                        <div class="car-booking-info__car-date-block car-booking-info__car-date-block--from"><span>{{App\Models\Translation::getTranslWord($words, $sel_lang, "receiving")}}</span><span>
                                            @if($order->location=="1")
                                                ...
                                                @endif
										</span><span>{{Carbon\Carbon::parse($order->date)->format('D, d/m/Y')}}, {{$order->time}}:00</span><a class="underline modal-open" href="#change-date">{{App\Models\Translation::getTranslWord($words, $sel_lang, "change")}}</a></div>
