            ...
            <div class="container">
                ...
                <div class="user-block">
                    ...
                    <div class="user-block__content">
                        <div class="user-block__top-btn"><a class="sm:min-w-0 btn btn--theme-accent3 min-w-340" href="{{route('partner_ticket.create')}}"><span>{{App\Models\Translation::getTranslWord($words, $sel_lang, "create_ticket2")}}</span></a></div>
                        <div class="user-block__table user-block__table--first-checkbox grouped-checkboxes mb-90 md:mb-40">
                            <table>
                                <tr>
                                    ...
                                    <th>{{App\Models\Translation::getTranslWord($words, $sel_lang, "ticket1")}}</th>
                                ...
                                @foreach($tickets as $ticket)
                                    <tr>
                                        ...
                                        <td>
                                            {{Form::open(['route'=>['partner_ticket.destroy',$ticket->id], 'method'=>'delete'])}}
                                        ...
                                        <td>
                                            <a class="message-btn" href="{{route('partner_ticket.edit', $ticket->id)}}">
                                    ...
                                    <ul>
                                        ...
                                        @for($i=1; $i<=(int)($tickets->lastPage()); $i++)
                                            ...
                                            @else
                                                ...
                                                @if($i==1)
                                                    <li><a href="{{route('partner_ticket.index')}}">{{$i}}</a></li>
                                                @else
                                                    <li><a href="{{route('partner_ticket.index').'\?page='.$i}}">{{$i}}</a></li>
                                                @endif
                                            @endif
