            ...
            <div class="container">
                ...
                <div class="user-block">
                    <div class="user-block__content pt-20">
                        ...
                        <form class="user-block__new-ticket" action="{{route('client_ticket.add_answer')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class=" {{$dialog->user->role->alias=="admin" ? 'comments mb-30' : 'comment'}}">
                                        ...
                                        @endif
                                                <div class="comment__top">
                                                    <div class="comment__name comment__name--no-icon">{{$dialog->user->role->alias=="admin" ? "RENTAL CARS" : App\Models\Translation::getTranslWord($words, $sel_lang, "your_message")}}</div>
